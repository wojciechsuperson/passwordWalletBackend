...
public class HmacPasswordEncoder {
    ...
    public boolean matches(String rawPassword, String encodedPassword, String key) {
        if (rawPassword == null) {
            throw new IllegalArgumentException("rawPassword cannot be null");
        } else if (encodedPassword != null && encodedPassword.length() != 0) {
            return encodedPassword.equals(calculateHMAC(rawPassword, key));
        } else {
            return false;
        }
    }
